...
cd 10_Matriz_Convencional_Loop_Unrolling_4_Iteracoes_PARALELA_DIRETIVA_O2
echo "10_Matriz_Convencional_Loop_Unrolling_4_Iteracoes_PARALELA_DIRETIVA_O2"
echo " "
bash script_gprof.sh
bash script_perf.sh
cd ..

cd 11_Matriz_Tiling_Loop_Unrolling_4_Iteracoes_PARALELA_DIRETIVA_O2
echo "11_Matriz_Tiling_Loop_Unrolling_4_Iteracoes_PARALELA_DIRETIVA_O2"
echo " "
bash script_gprof.sh
bash script_perf.sh
cd ..
